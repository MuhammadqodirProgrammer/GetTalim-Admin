...
export default function Category() {
  ...
  const descRef:any = useRef<HTMLInputElement>();

  const editnameRef:any = useRef<HTMLInputElement>();
  const editdescRef:any = useRef<HTMLInputElement>();
  // my toasts
  ...
  async function deleteFunc(evt: any) {
    ...
    const response = await instance.delete(`api/categories/${deleteID}`);
