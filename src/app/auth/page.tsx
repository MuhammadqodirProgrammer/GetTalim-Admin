				...
				<div className='flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0'>
					...
					>
						<img
							...
							src='https://resources.finalsite.net/images/f_auto,q_auto,t_image_size_1/v1616452743/davisk12utus/oittx8wvqew1gijbg9kh/CYESSLOLOGO-PrintCMYKTransparent.png'
							alt='logo'
						/>
						Get Ta'lim
					</a>
					<div className='w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700'>
						...
						{error && (
							<div
								id='popup-modal'
								className=' flex flex-col items-center justify-center fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full  '
							>
								<div className='relative w-full max-w-md max-h-full'>
									<div className='relative bg-gray-300 rounded-lg shadow dark:bg-gray-700'>
										...
										<div className='p-6 text-center'>
											...
											<h3 className='mb-5 text-lg font-normal text-red-700 dark:text-gray-400'>
