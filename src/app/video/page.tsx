...
<div className=" bg-[#111827] shadow-lg rounded-lg overflow-hidden my-4">

  <ReactPlayer url={videoUrl} controls  className="w-full h-56 object-cover object-center"/>

  <div className="py-4 px-6">
    <h1 className="text-2xl font-semibold text-gray-600">Video  name </h1>
    <p className="py-2 text-lg text-gray-600">Full Stack maker &amp; UI / UX Designer </p>
