...
export default function Module() {
  let myCourseId: string | null;
  if (typeof window !== 'undefined') {
    myCourseId = localStorage.getItem("course_id");
  }
    ...
    <div>
      ...
      {data.map((el: any) => {
        return (
          <>
            <div
              className="card flex border bg-gray-100 mb-3 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700   "
              key={el?.id}
            >
