    ...
    <>
      <header className="  header  fixed w-full z-50 top-0 left-0 flex items-center">
        <div className="flex  gap-x-5 m-auto  justify-between container items-center">
          <Link
            href="/"
            className="flex items-center font-semibold gap-2 text-[24px]"
          >
      ...
      {isOffcanvasOpen && (
        <nav className="navbar_offcanvas fixed top-0 left-0  h-screen  ">
          ...
          <div className=" bg-slate-600 dark:bg-slate-900 h-screen ">
              ...
              <Link href="bootcamp">
                ...
                >
                  <div className="flex items-center gap-x-2 justify-start">
                    ...
                    <p className="chakra-text css-0">Bootcamp</p>
                  </div>
                </button>
              </Link>
            </div>
