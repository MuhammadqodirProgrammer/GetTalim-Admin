					...
					<Link className='nav_link' href='/benefit'>
						...
						>
							<div className='flex items-center gap-x-2 justify-start'>
								...
								<p className='chakra-text css-0'>benifit</p>
							</div>
						</button>
					</Link>
					<Link className='nav_link' href='/comment'>
						...
						>
							<div className='flex items-center gap-x-2 justify-start'>
								...
								<p className='chakra-text css-0'>comment</p>
							</div>
						</button>
					</Link>
					...
					<Link className='nav_link' href='/mentor'>
						...
						>
							<div className='flex items-center gap-x-2 justify-start'>
								...
								<p className='chakra-text css-0'>mentor</p>
							</div>
						</button>
					</Link>
					...
					<Link className='nav_link' href='/module'>
						...
						>
							<div className='flex items-center gap-x-2 justify-start'>
								...
								<p className='chakra-text css-0'>module</p>
							</div>
						</button>
					</Link>
					...
					<Link className='nav_link' href='/requirement'>
						...
						>
							<div className='flex items-center gap-x-2 justify-start'>
								...
								<p className='chakra-text css-0'>requirement</p>
							</div>
						</button>
					</Link>
					...
					<Link className='nav_link' href='/student'>
						...
						>
							<div className='flex items-center gap-x-2 justify-start'>
								...
								<p className='chakra-text css-0'>studnet</p>
							</div>
						</button>
					</Link>
					...
					<Link className='nav_link' href='/video'>
						...
						>
							<div className='flex items-center gap-x-2 justify-start'>
								...
								<p className='chakra-text css-0'>video</p>
							</div>
						</button>
					</Link>
				</div>
